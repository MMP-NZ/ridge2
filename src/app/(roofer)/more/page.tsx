  ...
  return (
    <main className="flex flex-1 flex-col gap-4 p-4">
      ...
      <div className="rounded-xl border border-border bg-surface p-4 text-sm text-muted">
        <p>{PRODUCT_NAME}</p>
        <p className="mt-1">Account details land in a later milestone.</p>
      </div>

      <nav className="flex flex-col gap-2">
        <Link href="/price-book" className="rounded-lg border border-border bg-surface px-4 py-3 text-sm font-medium">
          Price book
        </Link>
